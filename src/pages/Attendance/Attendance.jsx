            ...
            <table className="w-full">
              <thead className="bg-gray-50">
                <tr>
                  ...
                  <th className="px-6 py-3 text-left text-sm font-semibold text-gray-700">Last Class #</th>
              ...
              <tbody className="divide-y divide-gray-200">
                {filteredAttendances.map((summary) => (
                  <tr key={summary.studentId} className="transition-colors hover:bg-gray-50">
                    <td className="px-6 py-2 text-sm font-medium text-gray-900">{summary.studentName}</td>
                    <td className="px-6 py-2 text-sm text-gray-600">{summary.studentPlace || '-'}</td>
                    <td className="px-6 py-2 text-sm text-gray-600">{summary.phoneNumber || '-'}</td>
                    <td className="px-6 py-2 text-sm text-gray-600">{summary.totalClassesTaken ?? 0}</td>
                    <td className="px-6 py-2 text-sm text-gray-600">{summary.lastClassNumber ?? '-'}</td>
